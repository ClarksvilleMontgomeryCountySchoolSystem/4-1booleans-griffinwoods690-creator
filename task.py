...
# The variable name that was easiest to work with is the "is_awake" variable since it was straightforward.
# Which were most confusing? Why?
# The "not" ones were the most confusing because it required me to think another step.
